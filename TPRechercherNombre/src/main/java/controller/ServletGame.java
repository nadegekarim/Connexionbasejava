...
public class ServletGame extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println("Tentative N° : " + compteur + " : " + UserSaisie + "(cible : " + randomNombre +")" );
			if (UserSaisie == randomNombre) {
				//response.sendRedirect("victoire.html");
				request.setAttribute("status", "victoire");
		...
		response.getWriter().append("Nombre d'essais : " + Cpt);
	}
